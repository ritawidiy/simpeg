  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Daftar Pegawai yang telah memasuki usia pensiun</h2>
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="vertical-align: middle">{{ \Carbon\Carbon::parse($value->tgl_lahir)->diffInYears(now()) }} Tahun</td>
