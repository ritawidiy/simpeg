...
@section('tittle', 'Biodata Pegawai: Filter Pangkat')
@section('content')
        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            <div class="row form-group">
              <div class="col-lg-12">
                <label for="filter" class="control-label">Filter Pangkat</label>
                <select id="filter" data-live-search="true" class="form-control selectpicker" title="-- Pilih --"
                  ...
                  <option value="{{ $item->namapangkat }}">{{ $item->namapangkat }}</option>                      
                  @endforeach
                </select>
              </div>
            </div>
