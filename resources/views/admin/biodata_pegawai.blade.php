        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Daftar {{ count($data) }} Pegawai</h2>
                        ...
                        <div class="x_content">
                            <div class="row form-group">
                                <div class="col-lg-6">
                                    ...
                                    <select id="unitKerja" data-live-search="true" class="form-control selectpicker"
                                            name="unitkerja" title="-- Pilih Unit Kerja --"
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select id="nama_pegawai" data-live-search="true" class="form-control selectpicker"
                                            name="nama_pegawai" title="-- Pilih Nama Pegawai --"
                                            data-max-options="1" multiple>
