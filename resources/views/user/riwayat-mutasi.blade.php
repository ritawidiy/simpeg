...
@section('tittle', 'Riwayat Mutasi | SIMPEG (Sistem Informasi Kepegawaian)')
@section('content')
        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 id="panel_title">Riwayat Mutasi</h2>
                                ...
                                @foreach ($data as $d)
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle" align="center">
                                            ...
                                            <button onclick="unggahBerkas('{{$d->id}}')" class="btn btn-primary btn-sm"
                                                    {{$d->status != "DISETUJUI" ? 'disabled' : ''}}>
                                                <i class="fa fa-upload"></i>&ensp;Berkas Mutasi
                                            </button>
                                        </td>
                                    </tr>
                                @endforeach
    ...
    <div id="berkasMutasiModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title">Form Unggah Berkas Mutasi</h4>
                </div>
                <form method="post" action="{{route('unggah.berkas-mutasi')}}" id="form-unggah-berkas">
                    {{csrf_field()}}
...
@push('script')
    <script>
        ...
        function unggahBerkas(id) {
            $("#form-unggah-berkas input[name=riwayatmutasi_id]").val(id);
